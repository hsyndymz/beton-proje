...
# TSE 802 Dmax Bağımlı Elek Serileri (Standart 13 Elek)
SIEVE_SETS = {
    31.5: [0.063, 0.15, 0.25, 0.5, 1, 2, 4, 8, 11.2, 16, 22.4, 31.5, 40],
    22.4: [0.063, 0.15, 0.25, 0.5, 1, 2, 4, 8, 11.2, 16, 22.4, 31.5, 40],
    16.0: [0.063, 0.15, 0.25, 0.5, 1, 2, 4, 8, 11.2, 16]
}

# TS 802 STANDART GRANÜLOMETRİ EĞRİLERİ (DIN 1045 Referanslı)
STD_GRADING_DB = {
    31.5: {
        # KTŞ 2023 Genel Beton (A-C: Zarf, B: Proje Şartnamesi)
        "A (Kaba)":   {40.0: [100,100], 31.5: [90,90], 22.4: [75,75], 16.0: [62,62], 11.2: [48,48], 8.0: [40,40], 4.0: [25,25], 2.0: [15,15], 1.0: [10,10], 0.5: [6,6], 0.25: [2,2], 0.15: [1,1], 0.063: [0,0], 0.0: [0,0]},
        ...
        "C (İnce)":   {40.0: [100,100], 31.5: [100,100], 22.4: [95,105], 16.0: [85,85], 11.2: [75,75], 8.0: [68,68], 4.0: [52,52], 2.0: [42,42], 1.0: [32,32], 0.5: [25,25], 0.25: [15,15], 0.15: [10,10], 0.063: [5,5], 0.0: [0,2]}
    },
    22.4: {
        # KTŞ 2023 Dmax 22.4 (Tip-I/II Zarfı ve Spec)
        "A (Kaba)":   {31.5: [100,100], 22.4: [90,90], 16.0: [75,75], 11.2: [62,62], 8.0: [50,50], 4.0: [35,35], 2.0: [25,25], 1.0: [16,16], 0.5: [10,10], 0.25: [5,5], 0.15: [2,2], 0.063: [0,0], 0.0: [0,0]},
        ...
        "C (İnce)":   {31.5: [100,100], 22.4: [100,100], 16.0: [100,100], 11.2: [95,95], 8.0: [85,85], 4.0: [75,75], 2.0: [60,60], 1.0: [45,45], 0.5: [35,35], 0.25: [25,25], 0.15: [15,15], 0.063: [6,6], 0.0: [0,2]}
    },
    16.0: {
