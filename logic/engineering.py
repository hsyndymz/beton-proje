...
STD_GRADING_DB = {
    ...
    22.4: {
        "A (Kaba)":   {31.5: [100,100], 22.4: [98,98], 16.0: [85,85], 11.2: [68,68], 8.0: [48,48], 4.0: [33,33], 2.0: [22,22], 1.0: [15,15], 0.5: [10,10], 0.25: [6,6], 0.15: [3,3], 0.063: [1,1], 0.0: [0,0]},
        ...
        "C (İnce)":   {31.5: [100,100], 22.4: [100,100], 16.0: [99,99], 11.2: [90,90], 8.0: [77,77], 4.0: [64,64], 2.0: [52,52], 1.0: [41,41], 0.5: [30,30], 0.25: [20,20], 0.15: [11,11], 0.063: [5,5], 0.0: [0,2]}
    },
    16.0: {
