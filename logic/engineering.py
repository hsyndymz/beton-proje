...
STD_GRADING_DB = {
    31.5: {
        "A (Kaba)":   {31.5: [100,100], 16.0: [62,75], 8.0: [40,55], 4.0: [25,40], 2.0: [15,30], 1.0: [8,20], 0.25: [2,8], 0.0: [0,2]},
        "B (İdeal)":  {31.5: [100,100], 16.0: [75,85], 8.0: [55,68], 4.0: [40,52], 2.0: [26,38], 1.0: [16,27], 0.25: [6,12], 0.0: [1,4]},
        "C (İnce)":   {31.5: [100,100], 16.0: [85,95], 8.0: [68,80], 4.0: [52,65], 2.0: [38,50], 1.0: [25,35], 0.25: [11,20], 0.0: [2,6]}
    },
    22.4: {
        "A (Kaba)":   {22.4: [100,100], 16.0: [70,85], 8.0: [45,60], 4.0: [28,42], 2.0: [18,32], 1.0: [10,22], 0.25: [3,10], 0.0: [0,4]},
        "B (İdeal)":  {22.4: [100,100], 16.0: [85,95], 8.0: [60,75], 4.0: [42,55], 2.0: [30,42], 1.0: [18,29], 0.25: [7,13], 0.0: [2,5]},
