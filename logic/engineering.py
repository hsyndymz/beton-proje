...
STD_GRADING_DB = {
    31.5: {
        "A (Kaba)":   {40.0: [100,100], 31.5: [90,96], 22.4: [75,85], 16.0: [62,75], 8.0: [40,55], 4.0: [25,40], 2.0: [15,30], 1.0: [8,20], 0.25: [2,8], 0.0: [0,2]},
        "B (İdeal)":  {40.0: [100,100], 31.5: [96,96], 22.4: [91,91], 16.0: [82,82], 11.2: [70,70], 8.0: [56,56], 4.0: [45,45], 2.0: [30,30], 1.0: [27,27], 0.5: [19,19], 0.25: [12,12], 0.15: [7,7], 0.063: [3,3], 0.0: [0,1]},
        "C (İnce)":   {40.0: [100,100], 31.5: [98,100], 22.4: [95,100], 16.0: [85,95], 8.0: [68,80], 4.0: [52,65], 2.0: [38,50], 1.0: [25,35], 0.25: [11,20], 0.0: [2,6]}
    },
    22.4: {
        "A (Kaba)":   {22.4: [100,100], 16.0: [70,85], 8.0: [45,60], 4.0: [28,42], 2.0: [18,32], 1.0: [10,22], 0.25: [3,10], 0.0: [0,4]},
        "B (İdeal)":  {40.0: [100,100], 31.5: [100,100], 22.4: [91,91], 16.0: [82,82], 11.2: [70,70], 8.0: [56,56], 4.0: [45,45], 2.0: [30,30], 1.0: [27,27], 0.5: [19,19], 0.25: [12,12], 0.15: [7,7], 0.063: [3,3], 0.0: [0,1]},
        "C (İnce)":   {22.4: [100,100], 16.0: [95,100], 8.0: [75,85], 4.0: [55,70], 2.0: [42,55], 1.0: [28,38], 0.25: [12,22], 0.0: [3,8]}
    },
    16.0: {
